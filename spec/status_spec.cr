...
describe Status do
  it "returns correct status when working" do
    statusmsg("./spec/timespans_when_working.json").should eq "Working since 14.06.2023 18:00"
  end
  ...
  it "returns correct status when on a break" do
    statusmsg("./spec/timespans_when_on_break.json").should eq "On a break since 14.06.2023 18:00"
  end
end
